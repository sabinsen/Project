            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/12promax.jpg" alt="Apple">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Iphone 12 pro max</h3>
                                    <p>Price: Rs. 1,80,000</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/11promax.jpg" alt="Iphone 11 pro max">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Iphone 11promax</h3>
                                    <p>Price: Rs. 1,47,000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/13.jpg" alt="Apple Product">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mac.jpg" alt="Apple">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Macbook pro</h3>
                                    <p>Price: Rs. 1,25,000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/galaxyz.jpg" alt="Samsung Galaxy Z Flip">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/s21.JPG" alt="Samsung s21">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Samsung S 21 </h3>
                                    <p>Price: Rs. 1,15,000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/s22.jpg" alt="Samsung s22">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Samsung s22</h3>
                                    <p>Price: Rs. 1,50,000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/nord.jpg" alt="Oneplue Nord">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Oneplus Nord</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/9pro.jpg" alt="Oneplus 9 pro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>9 Pro</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/6pro.jpg" alt="Oneplus 6pro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Oneplus 6 pro</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/8t.png" alt="Oneplus 8T">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Oneplus 8T</h3>
